...
namespace AppC5API.Controllers
{
    ...
    public class NguoiDungController : ControllerBase
    {
       private readonly IAllRepositories<NguoiDung> irepos;
        ...
        public bool CreateNguoiDung(string Ho, string Ten, string TenDangNhap, string MatKhau,
            Guid IdChucVu,int GioiTinh,string Email, string SDT,string DiaChi,int TrangThai)
        {
            ...
            NguoiDung.IdChucVu = Guid.Parse((ReadOnlySpan<char>)"1b3d693a - 4ed1 - 4a21 - 9810 - 9da7ff0f2d09");
        ...
        public bool UpdateNguoiDung(Guid id, string Ho, string Ten, string TenDangNhap, string MatKhau,
            Guid IdChucVu,int GioiTinh,string Email, string SDT,string DiaChi,int TrangThai)
        {
            NguoiDung NguoiDung = new NguoiDung()
            {
                ...
                MatKhau = MatKhau,
                IdChucVu = Guid.Parse((ReadOnlySpan<char>)"1b3d693a - 4ed1 - 4a21 - 9810 - 9da7ff0f2d09"),
                GioiTinh = GioiTinh,
                Email = Email,
                SDT = Email,
                DiaChi = DiaChi,
